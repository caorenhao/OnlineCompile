...
{   //页面 BODY中 ONLOAD中调用
 ...
 function   showMenu(id)
 {
    ...
    oPopup.show(window.event.clientX-8,   window.event.clientY-20,   popWidth,   popHeight,   document.body);
